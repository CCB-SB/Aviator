...
query = """("Nucleic acids research"[Journal]) AND ((D1[Issue]) OR (Database issue[Issue]) OR W1[Issue] OR (Web Server issue[Issue])) AND (("2010/01/01"[Date - Publication] : "3000"[Date - Publication]))"""
